...
n_mels = 128, n_fft = 1024, hop_length = 512 in fragments of 7s and 14s of each song. The resulting MFCC matrices have been stored 
in: 
    - 02-Data_out/Xy_14_MFCC1.pickle
    - 02-Data_out/Xy_7_MFCC1.pickle
...
#    mal = 0
#    for position in range(len(X_14)):
#        if X_7[position].shape != (128,300):
#            mal += 1
#            print(str(mal) + " --> index: ", str(position))
    ...
    SaveXy(X_14, y_14, "../02-Data_out/Xy_14_MFCC1.pickle")
    SaveXy(X_7, y_7, "../02-Data_out/Xy_7_MFCC1.pickle")
    ## Save sets 
