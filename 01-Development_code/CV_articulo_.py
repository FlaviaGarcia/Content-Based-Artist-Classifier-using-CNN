...
1D CONV(128 filters, kernel_size = 4, strides = 4) + MAX_POOLING(4x4) + 1D CONV(256 filters, kernel_size = 4, strides = 4) + MAX_POOLING(2x2) + 
FLATTEN + DENSE(1536) + DROPOUT(0.5) + DENSE(2048) + DROPOUT(0.5) + DENSE(2048) + DROPOUT(0.5) + DENSE(num_classes = 50)
